...
namespace _8._2.TWToolbar
{
    ...
    [ProvideToolWindow(typeof(_8._2.TWToolbar.TestToolWindow))]
    public sealed class TWTestCommandPackage : Package
    {
        /// <summary>
        /// TWTestCommandPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "37063225-d709-4ccc-a274-0014cf2ec73c";

        public const string guidTWTestCommandPackageCmdSet = "bef44572-c37d-4626-8a6a-ee90c1bffcd3";
        //从.vsct文件里获得的guidTWTestCommandPackageCmdSet值
        ...
        protected override void Initialize()
        {
            ...
            base.Initialize();
            _8._2.TWToolbar.TestToolWindowCommand.Initialize(this);
        }
